...
<body>
<center>
<form action="<%=request.getContextPath() %>/stus?action=querypwd" method="post" name="form1"  onsubmit="return check1() ">
用户名:<input  type="text"  value="<%=request.getParameter("stuname")%>">
...
<input  type="hidden"  name="id" value="<%=request.getParameter("stuid")%>">
